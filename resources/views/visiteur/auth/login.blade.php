...
<head>
    ...
    <title>Connexion | MR_LANIMATION </title>
</head>
                            ...
                            <div>
                                ...
                                <div class="d-flex flex-column gap-1">
                                    ...
                                    <span>
                                        ...
                                        <a href="{{ route('visiteur.register') }}" class="ms-1">S'inscrire</a>
                                    </span>
                                </div>
                            </div>
                            <!-- Form -->
                            <form class="needs-validation" method="POST" action="{{ route('visiteur.login') }}">
                                @csrf
                                <!-- Username -->
                                <div class="mb-3">
                                    ...
                                    <input type="email" id="signInEmail"
                                        ...
                                        value="{{ old('email') }}" name="email" placeholder="Adresse e-mail ici"
                                        required autofocus />
                                    @error('email')
