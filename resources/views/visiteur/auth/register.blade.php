...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Dec 2024 17:08:52 GMT -->
...
<head>
    ...
    <link rel="canonical" href="{{ route('visiteur.register') }}" />
                            ...
                            <div>
                                ...
                                <div class="d-flex flex-column gap-1">
                                    ...
                                    <span>
                                        ...
                                        <a href="{{ route('visiteur.login') }}" class="ms-1">Se connecter</a>
                                    </span>
                                </div>
                            </div>
                            <!-- Form -->
                            <form class="needs-validation" method="POST" action="{{ route('visiteur.register') }}">
                                @csrf
                                <!-- Username -->
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="agreeCheck">
                                            <span>
                                                J'accepte les
                                                <a href="terms-condition-page.html">Conditions d'Utilisation</a>
                                                et la
                                                <a href="terms-condition-page.html">Politique de Confidentialité.</a>
                                            </span>
                                        </label>
