                                                ...
                                                <span class="dropdown dropstart">
                                                    ...
                                                    <span class="dropdown-menu" aria-labelledby="courseDropdown1">
                                                        ...
                                                        <a class="dropdown-item"
                                                            onclick="event.preventDefault(); if(confirm('Êtes-vous sûr de vouloir supprimer cette categorie ?')) document.getElementById('delete-form-{{ $value->id }}').submit();"
                                                            href="#">
