...
<main>
    <!--Hero Section-->
    <section class="relative w-full px-5 pt-12 pb-20 sm:px-6 lg:px-8 lg:pt-16 lg:pb-28 bg-gray-800 bg-cover bg-center" style="background-image: url('ton-image-de-fond.jpg');">
        <div class="container mx-auto text-center">
            <h2 class="text-3xl font-semibold text-white">Mr. Lanimation – Là où le divertissement et le savoir se rencontrent !</h2>
            <p class="mt-4 text-lg text-gray-300">La voix de la jeunesse africaine en vidéo et en musique !</p>
            <div class="mt-8 space-y-6 sm:flex sm:space-y-0 sm:space-x-8 sm:justify-center">
                <div class="flex justify-center sm:w-1/3">
                    <div class="text-center p-8 bg-white bg-opacity-75 rounded-lg shadow-lg">
                        <h3 class="text-xl font-semibold text-gray-800">Interviews, podcasts, musique et formations – tout ce qu’il te faut au même endroit !</h3>
                        <p class="mt-4 text-gray-600">Ton abonnement, ta porte d’entrée vers l’excellence culturelle et éducative !</p>
                    </div>
                </div>
                <div class="flex justify-center sm:w-1/3">
                    <div class="text-center p-8 bg-white bg-opacity-75 rounded-lg shadow-lg">
                        <h3 class="text-xl font-semibold text-gray-800">Le carrefour des artistes, penseurs et créateurs africains !</h3>
                        <p class="mt-4 text-gray-600">Rejoignez la communauté qui valorise l'innovation et la culture !</p>
                    </div>
                </div>
            </div>
            <div class="mt-12">
                <a href="#abonnement" class="inline-block text-lg font-semibold text-blue-600 hover:text-blue-800">Rejoindre l’aventure</a>
                <a href="#explorer" class="ml-4 inline-block text-lg font-semibold text-blue-600 hover:text-blue-800">Explorer les formations</a>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-xl-10 col-md-10 col-12 mx-auto">
                    <div class="d-flex flex-column gap-2 text-center mb-xl-7 mb-5">
                        ...
                        <p class="mb-0 px-xl-5">Discover a world of knowledge through our diverse range of courses.
                        </p>
                    </div>
                </div>
            </div>
                                ...
                                <svg width="64" height="64" viewBox="0 0 64 64" fill="none"
                                    ...
                                    <g clip-path="url(#clip0_7928_12745)">
                                        ...
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            fill="" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M44.5612 43.8203C44.3185 43.9821 43.6627 44.4526 43.9054 44.6953L50.5027 51.2774L51.2098 50.5703"
                                            fill="" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <span class="icon-shape icon-xxl">
                                <svg width="64" height="64" viewBox="0 0 64 64" fill="none"
                                    ...
                                    <g clip-path="url(#clip0_7928_12752)">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M62.8327 22.7079H43.0549V39.3622H62.8327V22.7079ZM63.8327 21.7079V40.3622H42.0549V21.7079H63.8327Z"
                                            fill="" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <span class="icon-shape icon-xxl">
                                <svg width="64" height="64" viewBox="0 0 64 64" fill="none"
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        fill="" />
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M26.2152 50L25.1617 57H38.8489L37.8613 50H26.2152ZM38.7301 49H25.3544L23.9999 58H39.9999L38.7301 49Z"
                                        fill="" />
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        fill="" />
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M0.566647 39.5151H63.4344V40.6464H0.565639L0.566647 39.5151Z"
                                        fill="" />
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <span class="icon-shape icon-xxl">
                                <svg width="64" height="64" viewBox="0 0 64 64" fill="none"
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        fill="" />
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M63.3526 18.1589H0.482178V17.3519H63.3526V18.1589Z" fill="" />
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M0.482178 18.1589V17.3519H63.3526V18.1589H0.482178Z" fill="" />
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        fill="" />
                                    <path
                                        d="M19.4083 30.9396L22.355 28.0051C22.5971 27.763 22.9199 27.763 23.0814 28.0051C23.3235 28.2472 23.3235 28.5701 23.0814 28.7315L20.1334 31.671L19.4083 30.9396Z"
                                        fill="" />
                                    <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-12 mx-auto">
                    <div class="d-flex flex-column gap-2 text-center mb-xl-7 mb-5">
                        ...
                        <p class="mb-0">Whether you want to advance your career, learn a new skill, or explore a
                            passion, we have the right course for you.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="sliderFirst py-3">
                    <div class="item">
                        <div class="card card-lift">
                            <a href="#!">
                                <img src="assets/images/course/python.jpg" alt="figma"
                            ...
                            <div class="card-body d-flex flex-column gap-4">
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <h3 class="mb-0 h4">
                                        <a href="#!" class="text-inherit">Master the basics of data
                                            analysis with Python</a>
                                    </h3>
                    ...
                    <div class="item">
                        <div class="card card-lift">
                            <a href="#!">
                                <img src="assets/images/course/figma.jpg" alt="figma"
                                    class="card-img-top img-fluid w-100" />
                            </a>
                            <div class="card-body d-flex flex-column gap-4">
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <h3 class="mb-0 h4">
                                        <a href="#!" class="text-inherit">Figma UI UX Design Course for the
                                            Beginner</a>
                                    </h3>
                    ...
                    <div class="item">
                        <div class="card card-lift">
                            <a href="#!">
                                <img src="assets/images/course/nuxt.jpg" alt="figma"
                                    class="card-img-top img-fluid w-100" />
                            </a>
                            <div class="card-body d-flex flex-column gap-4">
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <h3 class="mb-0 h4">
                                        <a href="#!" class="text-inherit">About the Nuxt.js Fundamentals
                                            course</a>
                                    </h3>
                    ...
                    <div class="item">
                        <div class="card card-lift">
                            <a href="#!">
                                <img src="assets/images/course/aws.jpg" alt="figma"
                                    class="card-img-top img-fluid w-100" />
                            </a>
                            <div class="card-body d-flex flex-column gap-4">
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <h3 class="mb-0 h4">
                                        <a href="#!" class="text-inherit">AWS Fundamentals
                                            Specialization</a>
                                    </h3>
                    ...
                    <div class="item">
                        <div class="card card-lift">
                            <a href="#!">
                                <img src="assets/images/course/mongodb.jpg" alt="figma"
                                    class="card-img-top img-fluid w-100" />
                            </a>
                            <div class="card-body d-flex flex-column gap-4">
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <h3 class="mb-0 h4">
                                        <a href="#!" class="text-inherit">MongoDB - The Complete
                                            Developer's Guide 2024</a>
                                    </h3>
                    ...
                    <div class="item">
                        <div class="card card-lift">
                            <a href="#!">
                                <img src="assets/images/course/supabase.jpg" alt="figma"
                                    class="card-img-top img-fluid w-100" />
                            </a>
                            <div class="card-body d-flex flex-column gap-4">
                                <div class="d-flex flex-column gap-2">
                                    <div>
                                        <span
                                            class="badge text-light-emphasis bg-light-subtle border border-light-subtle rounded-pill">Programming</span>
                                    </div>
                                    <h3 class="mb-0 h4">
                                        <a href="#!" class="text-inherit">Supabase From Scratch: Serverless
                                            Database</a>
                                    </h3>
                    ...
                    <div class="item">
                        <div class="card card-lift">
                            <a href="#!">
                                <img src="assets/images/course/bootstrap.jpg" alt="figma"
                                    class="card-img-top img-fluid w-100" />
                            </a>
                            <div class="card-body d-flex flex-column gap-4">
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <h3 class="mb-0 h4">
                                        <a href="#!" class="text-inherit">Create Modern Website Using
                                            HTML,CSS And Bootstrap</a>
                                    </h3>
                ...
                <div class="col-12">
                    <div class="d-flex flex-column gap-4 text-center mb-xl-7 mb-5">
                        <div class="d-flex flex-column gap-2">
                            ...
                            <p class="mb-0">From critical skills to technical topics, Udemy supports your
                        ...
                        <div class="card-body p-5 d-flex flex-column gap-3">
                            ...
                            <div class="d-flex flex-column gap-6">
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <p class="mb-0">
                                        "I was struggling to grasp the concepts in my subject until I enrolled in
                                        this course. The interactive lessons and the support from the instructors
                                        were incredible. I feel more
                                        confident and prepared for my exams now. Highly recommend it to anyone
                                        looking to excel!"
                                    </p>
                                </div>
                                    ...
                                    <div class="d-flex flex-row gap-2 align-items-center">
                                        <a href="#!" class="icon-link icon-link-hover">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14"
                                                height="14" fill="currentColor" class="bi bi-chevron-right"
                                                viewBox="0 0 16 16">
                                                <path fill-rule="evenodd"
                        ...
                        <div class="card-body p-5 d-flex flex-column gap-3">
                            ...
                            <div class="d-flex flex-column gap-6">
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <p class="mb-0">
                                        "This course exceeded my expectations. The material is presented in a clear
                                        and engaging way, making even the most complex topics easy to understand.
                                        The quizzes and
                                        assignments helped reinforce my learning. I can’t thank the team enough for
                        ...
                        <div class="card-body p-5 d-flex flex-column gap-3">
                            ...
                            <div class="d-flex flex-column gap-6">
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <p class="mb-0">
                                        "As a working professional, I needed a course that fit into my busy
                                        schedule. This course was perfect! The flexible pacing allowed me to learn
                                        at my own speed, and the
                                        practical applications taught in the course have already helped me in my
                                        job. I’m looking forward to taking more courses from this platform."
                                    </p>
                                </div>
                                <div class="d-flex flex-column gap-4">
                                    <div class="d-flex flex-row gap-3 align-items-center">
            ...
            <div class="row">
                <div class="col-xl-6 col-md-8 col-12 mx-auto">
                    <div class="d-flex flex-column gap-2 text-center mb-xl-7 mb-5">
                        ...
                        <p class="mb-0">Level up your coding skills by practicing the hiring assessments of your
                        ...
                        <div class="d-flex flex-row gap-5">
                            ...
                            <div class="d-flex flex-column gap-4">
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <p class="mb-0 pe-xl-4">Lorem ipsum dolor sit amet, consectetur adi piscing
                                        elit. Aliquam sollicitudin eros enim, sed semper nunc tincidunt non.</p>
                                </div>
                                <div class="">
                                    <a href="#!" class="icon-link icon-link-hover">
                        ...
                        <div class="d-flex flex-row gap-5">
                            ...
                            <div class="d-flex flex-column gap-4">
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <p class="mb-0 pe-xl-4">Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit. Aliquam sollicitudin eros enim, sed semper nunc tincidunt non.</p>
                                </div>
                                <div>
                                    <a href="#!" class="icon-link icon-link-hover">
                        ...
                        <div class="row row-cols-lg-5 row-cols-md-3 row-cols-2 g-4 flex-nowrap">
                            <div class="col">
                                <div class="text-center mb-3">
                                    <img src="assets/images/course/office.svg" alt="office"
                                        class="img-fluid" />
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center mb-3">
                                    <img src="assets/images/course/linkedin-logo.svg" alt="linkedin"
                                        class="img-fluid" />
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center mb-3">
                                    <img src="assets/images/course/facebook.svg" alt="facebook"
                                        class="img-fluid" />
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center mb-3">
                                    <img src="assets/images/course/google.svg" alt="google"
                                        class="img-fluid" />
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center mb-3">
                                    <img src="assets/images/course/microsoft.svg" alt="microsoft"
                                        class="img-fluid" />
                                </div>
                            </div>
                        </div>
