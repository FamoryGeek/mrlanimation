            ...
            <div class="row align-items-center gy-6 gy-xl-0">
                    ...
                    <div class="d-flex flex-column gap-5">
                        ...
                        <div class="d-flex flex-column gap-3">
                            <div class="d-flex flex-column gap-2">
                                ...
                                <p class="mb-0">Hands-on training, and certifications to help you get the most
                                    from Geeks Learning.</p>
                            </div>
                ...
                <div class="col-xxl-6 offset-xxl-1 col-lg-7 col-12">
                    <div class="row gx-0 gy-4 gy-lg-0">
                        <div
                            class="col-md-6 flex-column justify-content-start align-items-center d-none d-md-flex">
                        ...
                        <div class="col-md-6 d-none d-md-block">
                            <div class="position-relative mt-5">
                                ...
                                <div
                                    class="bg-white rounded-4 p-3 position-absolute bottom-10 start-10 mb-3 shadow">
